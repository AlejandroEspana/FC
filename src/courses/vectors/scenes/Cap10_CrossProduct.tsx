            ...
            >
              <div className="space-y-3 font-mono text-xs">
                <div className="p-3 rounded-xl bg-black/40 border border-white/10 flex items-center justify-between">
                  <span className="text-slate-400 font-sans">Componente X:</span>
                  <Equation latex="\det \begin{bmatrix} a_y & a_z \\ b_y & b_z \end{bmatrix} \hat{i}" fontSize="text-sm" block={false} />
                </div>
                <div className="p-3 rounded-xl bg-black/40 border border-white/10 flex items-center justify-between">
                  <span className="text-slate-400 font-sans">Componente Y (con signo negativo):</span>
                ...
                <div className="p-3 rounded-xl bg-white/10 border border-white/20 flex items-center justify-between">
                  <span className="text-emerald-400 font-bold font-sans">Componente Z (Cruz 2D):</span>
      ...
      <Sequence from={300} durationInFrames={270} name="Fase_AreaOrtogonalidad">
        <div className="grid grid-cols-12 gap-6 w-full items-center h-full px-2">
          ...
          <div className="col-span-6 flex flex-col gap-3.5">
            ...
            >
              <div className="space-y-3 font-mono text-xs">
                <div className="p-3.5 rounded-xl bg-black/40 border border-white/10 flex flex-col gap-1.5">
                  <span className="text-slate-400 font-sans">1. Ortogonalidad con el vector a:</span>
                  <Equation latex="(\vec{a} \times \vec{b}) \cdot \vec{a} = 0" fontSize="text-sm" />
                </div>
                <div className="p-3.5 rounded-xl bg-black/40 border border-white/10 flex flex-col gap-1.5">
                  <span className="text-slate-400 font-sans">2. Ortogonalidad con el vector b:</span>
                  <Equation latex="(\vec{a} \times \vec{b}) \cdot \vec{b} = 0" fontSize="text-sm" />
                </div>
                <div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 font-sans text-xs">
