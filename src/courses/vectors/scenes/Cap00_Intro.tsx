              ...
              >
                <div className="space-y-2.5">
                  <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-blue-100 text-blue-700 font-mono font-bold flex items-center justify-center shrink-0 text-xs border border-blue-300">
                      1
                    </span>
                    <div>
                      <h4 className="text-xs font-bold text-slate-900">Magnitud o Norma (|v|)</h4>
                  ...
                  <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-amber-100 text-amber-800 font-mono font-bold flex items-center justify-center shrink-0 text-xs border border-amber-300">
                      2
                    </span>
                    <div>
                      <h4 className="text-xs font-bold text-slate-900">Dirección (Recta Directriz)</h4>
                      <p className="text-[11px] text-slate-600 font-sans mt-0.5">
                  ...
                  <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-emerald-100 text-emerald-800 font-mono font-bold flex items-center justify-center shrink-0 text-xs border border-emerald-300">
                      3
                    </span>
                    <div>
                      <h4 className="text-xs font-bold text-slate-900">Sentido (Orientación de la Punta)</h4>
                      <p className="text-[11px] text-slate-600 font-sans mt-0.5">
          ...
          <div className="grid grid-cols-12 gap-6 w-full items-center h-full px-2">
            ...
            <div className="col-span-4 flex flex-col h-full">
              ...
              >
                ...
                <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-900">
